...
public class SelectAllMappedStatementBuilder extends MappedStatementBuilder {
    ...
    public SelectAllMappedStatementBuilder(Configuration config, Class mapperClass, WordMode sqlMode, WordMode keywordMode) {
        super(config, mapperClass.getName(), mapperClass, extractEntityClass(mapperClass, SelectAllMapper.class), extractKeyClass(mapperClass, SelectMapper.class), sqlMode, keywordMode);
    }
